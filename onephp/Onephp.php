...
class Onephp
{
    ...
    public function route()
    {
        ...
        // 如果控制器和操作名存在，则实例化控制器，因为控制器控制器对象里面
    ...
    // 参考：http://php.net/manual/zh/ini.core.php#ini.register-globals
    public function unregisterGlobals()
    {
        if (ini_get('register_globals')) {
            $array = array('_SESSION', '_POST', '_GET', 'COOKIE', '_REQUEST', '_SERVER', '_ENV', '_FILES');
